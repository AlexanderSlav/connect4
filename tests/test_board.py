...
from src.enums import Player, GameState, MoveResult, Direction
...
class TestGameBoard:
    ...
    def test_make_move_success(self, board):
        ...
        assert board.move_history[0] == (5, 0, Player.RED)
    ...
    def test_check_winner_draw(self, small_board):
        ...
        # Create a carefully crafted pattern that avoids 3-in-a-row
        moves = [
            # Bottom row: RED YELLOW RED YELLOW
            (1, Player.RED), (2, Player.YELLOW), (3, Player.RED), (4, Player.YELLOW),
            # Third row: YELLOW RED YELLOW RED  
            (1, Player.YELLOW), (2, Player.RED), (3, Player.YELLOW), (4, Player.RED),
            # Second row: RED YELLOW RED YELLOW
            (1, Player.RED), (2, Player.YELLOW), (3, Player.RED), (4, Player.YELLOW),
            # Top row: YELLOW RED YELLOW RED (but modify 3rd column to break diagonal)
            (1, Player.YELLOW), (2, Player.RED), (3, Player.RED), (4, Player.RED)
        ]
