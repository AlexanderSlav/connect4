from src.consts import (
    WELCOME_TEXT, GOODBYE_TEXT, GAME_MODE_PROMPT, SETUP_SINGLE_PLAYER, 
    SETUP_TWO_PLAYER, WIN_MESSAGES, AI_THINKING, AI_MOVE, AI_FALLBACK, 
    AI_ERROR, ERROR_COLUMN_FULL, ERROR_INVALID_COLUMN, ERROR_UNKNOWN, 
    ERROR_GAME_INTERRUPTED, PROMPT_PRESS_ENTER, PROMPT_START_GAME
)
from src.board import GameBoard
from src.enums import GameState, Player, MoveResult
...
class GameEngine:
    ...
    def play_human_turn(self) -> None:
        ...
        while True:
            try:
                col = self.input_handler.get_column_input(self.current_player, self.config.cols)
                ...
                if result == MoveResult.SUCCESS:
                    ...
                    self.input_handler.display_error(ERROR_INVALID_COLUMN.format(col, self.config.cols))
                else:
